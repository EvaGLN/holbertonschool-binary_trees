...
## Table of Contents :
  ...
  - [0. New node](#subparagraph0)
  - [1. Insert left](#subparagraph1)
  - [2. Insert right](#subparagraph2)
  - [3. Delete](#subparagraph3)
  - [4. Is leaf](#subparagraph4)
  - [5. Is root](#subparagraph5)
  - [6. Pre-order traversal](#subparagraph6)
  - [7. In-order traversal](#subparagraph7)
  - [8. Post-order traversal](#subparagraph8)
  - [9. Height](#subparagraph9)
  - [10. Depth](#subparagraph10)
  - [11. Size](#subparagraph11)
  - [12. Leaves](#subparagraph12)
  - [13. Nodes](#subparagraph13)
  - [14. Balance factor](#subparagraph14)
  - [15. Is full](#subparagraph15)
  - [16. Is perfect](#subparagraph16)
  - [17. Sibling](#subparagraph17)
  - [18. Uncle](#subparagraph18)
  - [19. Lowest common ancestor](#subparagraph19)
  - [20. Level-order traversal](#subparagraph20)
  - [21. Is complete](#subparagraph21)
  - [22. Rotate left](#subparagraph22)
  - [23. Rotate right](#subparagraph23)
  - [24. Is BST](#subparagraph24)
  - [25. BST - Insert](#subparagraph25)
  - [26. BST - Array to BST](#subparagraph26)
  - [27. BST - Search](#subparagraph27)
  - [28. BST - Search](#subparagraph28)
  - [29. BST - Remove](#subparagraph29)
  - [30. Big O #BST](#subparagraph30)
  - [31. Is AVL](#subparagraph31)
  - [32. AVL - Insert](#subparagraph32)
  - [33. AVL - Array to AVL](#subparagraph33)
  - [34. AVL - Remove](#subparagraph34)
  - [35. AVL - From sorted array](#subparagraph35)
  - [36. Big O #AVL Tree](#subparagraph36)
  - [37. Is Binary heap](#subparagraph37)
  - [38. Heap - Insert](#subparagraph38)
  - [39. Heap - Array to Binary Heap](#subparagraph39)
  - [40. Heap - Extract](#subparagraph40)
  - [41. Heap - Sort](#subparagraph41)
  - [42. Big O #Binary Heap](#subparagraph42)
  - [43. Big O #Binary Heap](#subparagraph43)
## Resources

**Read or watch**:

- [Binary tree](/rltoken/Fh5nlgv82l1bUbWmdSNwaQ) (*note the first line: `Not to be confused with B-tree.`*)
- [Data Structure and Algorithms - Tree](/rltoken/fmFIIvUSROgY2lUOBy7S5A) 
- [Tree Traversal](/rltoken/eM-xhVxz4ss4clru2cyVqQ) 
- [Binary Search Tree](/rltoken/753pOe8BipA5bSJzZCrqeg) 
- [Data structures: Binary Tree](/rltoken/xTtNtmcL9Z6EmChV67Ce8A) 

## Learning Objectives

At the end of this project, you are expected to be able to [explain to anyone](/rltoken/p-z8FiBY0B3y09a87_1XAA), __without the help of Google__:
...
## Task
### 0. New node <a name='subparagraph0'></a>
...
### 1. Insert left <a name='subparagraph1'></a>
...
### 2. Insert right <a name='subparagraph2'></a>
...
### 3. Delete <a name='subparagraph3'></a>
...
### 4. Is leaf <a name='subparagraph4'></a>
...
### 5. Is root <a name='subparagraph5'></a>
...
### 6. Pre-order traversal <a name='subparagraph6'></a>
...
### 7. In-order traversal <a name='subparagraph7'></a>
...
### 8. Post-order traversal <a name='subparagraph8'></a>
...
### 9. Height <a name='subparagraph9'></a>
...
### 10. Depth <a name='subparagraph10'></a>
...
### 11. Size <a name='subparagraph11'></a>
...
### 12. Leaves <a name='subparagraph12'></a>
...
### 13. Nodes <a name='subparagraph13'></a>
...
### 14. Balance factor <a name='subparagraph14'></a>
...
### 15. Is full <a name='subparagraph15'></a>
...
### 16. Is perfect <a name='subparagraph16'></a>
...
### 17. Sibling <a name='subparagraph17'></a>
...
### 18. Uncle <a name='subparagraph18'></a>
...
### 19. Lowest common ancestor <a name='subparagraph19'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 100-main.c 100-binary_trees_ancestor.c 0-binary_tree_node.c -o 100-ancestor
...
### 20. Level-order traversal <a name='subparagraph20'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 101-main.c 101-binary_tree_levelorder.c 0-binary_tree_node.c 3-binary_tree_delete.c -o 101-lvl
...
### 21. Is complete <a name='subparagraph21'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 102-main.c 102-binary_tree_is_complete.c 0-binary_tree_node.c 3-binary_tree_delete.c -o 102-complete
...
### 22. Rotate left <a name='subparagraph22'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 103-binary_tree_rotate_left.c 103-main.c 0-binary_tree_node.c -o 103-rotl
...
### 23. Rotate right <a name='subparagraph23'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 104-binary_tree_rotate_right.c 104-main.c 0-binary_tree_node.c -o 104-rotr
...
### 24. Is BST <a name='subparagraph24'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 110-main.c 110-binary_tree_is_bst.c 0-binary_tree_node.c -o 110-is_bst
...
### 25. BST - Insert <a name='subparagraph25'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 111-bst_insert.c 111-main.c 0-binary_tree_node.c -o 111-bst_insert
...
### 26. BST - Array to BST <a name='subparagraph26'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 112-array_to_bst.c 112-main.c 111-bst_insert.c 0-binary_tree_node.c -o 112-bst_array
...
### 27. BST - Search <a name='subparagraph27'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 113-bst_search.c 113-main.c 112-array_to_bst.c 111-bst_insert.c 0-binary_tree_node.c -o 113-bst_search
...
### 28. BST - Search <a name='subparagraph28'></a>
...
### 29. BST - Remove <a name='subparagraph29'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 114-bst_remove.c 114-main.c 112-array_to_bst.c 111-bst_insert.c 0-binary_tree_node.c 3-binary_tree_delete.c -o 114-bst_rm
...
### 30. Big O #BST <a name='subparagraph30'></a>
...
### 31. Is AVL <a name='subparagraph31'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 120-main.c 120-binary_tree_is_avl.c 0-binary_tree_node.c -o 120-is_avl
...
### 32. AVL - Insert <a name='subparagraph32'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 121-avl_insert.c 121-main.c 14-binary_tree_balance.c 103-binary_tree_rotate_left.c 104-binary_tree_rotate_right.c 0-binary_tree_node.c -o 121-avl_insert
...
### 33. AVL - Array to AVL <a name='subparagraph33'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 122-array_to_avl.c 122-main.c 121-avl_insert.c 0-binary_tree_node.c 14-binary_tree_balance.c 103-binary_tree_rotate_left.c 104-binary_tree_rotate_right.c -o 122-avl_array
...
### 34. AVL - Remove <a name='subparagraph34'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 123-avl_remove.c 123-main.c 103-binary_tree_rotate_left.c 104-binary_tree_rotate_right.c 122-array_to_avl.c 121-avl_insert.c 14-binary_tree_balance.c 3-binary_tree_delete.c 0-binary_tree_node.c -o 123-avl_rm
...
### 35. AVL - From sorted array <a name='subparagraph35'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 124-main.c 124-sorted_array_to_avl.c 0-binary_tree_node.c -o 124-avl_sorted
...
### 36. Big O #AVL Tree <a name='subparagraph36'></a>
...
### 37. Is Binary heap <a name='subparagraph37'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 130-main.c 130-binary_tree_is_heap.c 0-binary_tree_node.c -o 130-is_heap
...
### 38. Heap - Insert <a name='subparagraph38'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 131-main.c 131-heap_insert.c 0-binary_tree_node.c -o 131-heap_insert
...
### 39. Heap - Array to Binary Heap <a name='subparagraph39'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 132-main.c 132-array_to_heap.c 131-heap_insert.c 0-binary_tree_node.c -o 132-heap_array
...
### 40. Heap - Extract <a name='subparagraph40'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 133-main.c 133-heap_extract.c 132-array_to_heap.c 131-heap_insert.c 3-binary_tree_delete.c -o 133-heap_extract
...
### 41. Heap - Sort <a name='subparagraph41'></a>
...
alex@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -std=gnu89 binary_tree_print.c 134-main.c 134-heap_to_sorted_array.c 133-heap_extract.c 132-array_to_heap.c 131-heap_insert.c -o 134-heap_sort
...
### 42. Big O #Binary Heap <a name='subparagraph42'></a>
...
### 43. Big O #Binary Heap <a name='subparagraph43'></a>
